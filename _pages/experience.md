...
- Building trajectory recording, review, replay, and dataset export infrastructure.
- Connecting physics-grounded rollouts with Isaac-based high-fidelity visual generation.
- Supporting dual-arm garment tasks, multi-camera observations, and scalable training-data production.
